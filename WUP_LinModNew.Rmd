...
```
model 1 has a residual standard error of 217.88 which is higher than the one for model3. and the p value shows that there is a signifacant difference between model 1 and 3 , therefor model 3 is better than model 1. 
